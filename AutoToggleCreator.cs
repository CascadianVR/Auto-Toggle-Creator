...
namespace CasTools.VRC_Auto_Toggle_Creator
{
    public class AutoToggleCreator : EditorWindow
    {
        ...
        public static int TogglesCount = 0;
        ...
        public void OnGUI()
        {
            ...
            scrollPos2 = EditorGUILayout.BeginScrollView(scrollPos2 ,  GUILayout.ExpandHeight(true), GUILayout.MinHeight(50));
            bool errorPass = false;
            errorPass = debugMenu.CheckToggleNames(Toggles);
        ...
        private void GroupList()
        {
            ...
            {
                GUIStyle nameStyle = new GUIStyle("textfield") { fontSize = 14 };
                ...
                Toggles[i].toggleName = GUILayout.TextField(Toggles[i].toggleName, nameStyle, GUILayout.ExpandWidth(true), GUILayout.MinWidth(100f), GUILayout.ExpandWidth(false));
                Toggles[i].seperateObject = EditorGUILayout.ToggleLeft(
                    new GUIContent("Seperate","Seperate toggles and select between - Only one can be on at a time for the group."),
                    Toggles[i].seperateObject,
        ...
        private void AutoFillSelection()
        {
            ...
            {
                if (Selection.activeTransform.GetComponent<Animator>() == null)
                {
                    return;
                }
